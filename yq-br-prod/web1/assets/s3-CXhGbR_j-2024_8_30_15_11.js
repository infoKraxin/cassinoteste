const __vite__fileDeps=["assets/loadCognitoIdentity-DEBrQTe0-2024_8_30_15_11.js","assets/index-a_Ow1xUN-2024_8_30_15_11.js","assets/index-CPzRzJM3-2024_8_30_15_11.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { $ as __vitePreload, bD as generateUniqueFileName } from "./index-a_Ow1xUN-2024_8_30_15_11.js";
...
function fromCognitoIdentity(parameters) {
  return async () => {
    ...
    const { GetCredentialsForIdentityCommand, CognitoIdentityClient } = await __vitePreload(() => import("./loadCognitoIdentity-DEBrQTe0-2024_8_30_15_11.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
...
function fromCognitoIdentityPool$1({ accountId, cache = localStorage(), client, clientConfig, customRoleArn, identityPoolId: identityPoolId2, logins, userIdentifier = !logins || Object.keys(logins).length === 0 ? "ANONYMOUS" : void 0, logger: logger2, parentClientConfig }) {
  ...
  let provider = async () => {
    var _a;
    const { GetIdCommand, CognitoIdentityClient } = await __vitePreload(() => import("./loadCognitoIdentity-DEBrQTe0-2024_8_30_15_11.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
