import { q as useUserInfoStore, r as reactExports, x as useNavigate, B as useGameStore, aB as getGamesNav, K as jsxRuntimeExports, aa as customToFixed, bE as getRebateConfig } from "./index-a_Ow1xUN-2024_8_30_15_11.js";
import { l as useTranslation, ac as rebateTypes, ad as MoreInMineIcon, k as LeftNav } from "./App-D9NLPZJN-2024_8_30_15_11.js";
const svg_theme_fill_color = "_svg_theme_fill_color_10gsp_3";
const container = "_container_10gsp_55";
const header = "_header_10gsp_59";
const more = "_more_10gsp_208";
const img = "_img_10gsp_338";
const listContainer = "_listContainer_10gsp_390";
const left_nav = "_left_nav_10gsp_395";
const rightContainer = "_rightContainer_10gsp_405";
const rightItem = "_rightItem_10gsp_410";
const first = "_first_10gsp_584";
const index = "_index_10gsp_594";
const second = "_second_10gsp_649";
const css = {
