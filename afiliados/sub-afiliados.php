...
<?php
include_once $_SERVER['DOCUMENT_ROOT'] . "/afiliados/afiliados/counts.php";
    ...
    <div class="col-12">
        <div class="card h-100 ">
            <div class="card-header">
                <h5 class="mb-0 ">Subordinados dos meus subordinados (Sub Lv2)</h5>
            </div>
            <div class="card-body pt-0">
                <div class="table-responsive">
                    <table class="table table-flush" id="datatable-basic">
                        ...
                        <tbody>
                            <?php foreach ($datasubafl as $subsubordinados) { ?>
                                <tr>
                                    <td class="text-sm font-weight-normal"><?= $subsubordinados['real_name'] ?></td>
                                    <td class="text-sm font-weight-normal"><?= $subsubordinados['tipo'] ?></td>
                                    <td class="text-sm font-weight-normal">R$ <?= number_format($subsubordinados['depositos'], 2, ',', '.') ?></td>
                                    <td class="text-sm font-weight-normal">R$ <?= number_format($subsubordinados['comissao'], 2, ',', '.') ?></td>
                                    <td class="text-sm font-weight-normal">
                                        <?php switch ($subsubordinados['status']) {
                                            case 'aguardando':
                                        ?>
                                    ...
                                    <td class="text-sm font-weight-normal"><?= $subsubordinados['data'] ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
