...
if(($resultado_usuario) AND ($resultado_usuario->num_rows != 0)){?>
  ...
  <div class="table-main-container">
                ...
                <div class="recent-orders-table-row">
                 ...
                 <div id="w-node-_0b909741-5d5c-5abc-5f7b-bcb01b609a5f-1b609a5a" class="flex align-center"><div class="paragraph-small color-neutral-100"><?=ver_data($data['data_hora']);?></div></div>
