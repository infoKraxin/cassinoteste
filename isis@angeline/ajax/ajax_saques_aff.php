                                ...
                                <form role="form" method="post">
                                    <div class="box-body">
                                        ...
                                        <div class="china-form">
                                            ...
                                            <input type="text" class="china-form" id="exampleInputEmail1" value="<?= $data_return['nome']; ?>" readonly>
                                        </div>
                                        <div class="china-form">
                                            <label for="exampleInputEmail1">Tipo Pix</label>
                                            <input type="text" class="china-form" id="exampleInputEmail1" value="<?= $data['tipo']; ?>" readonly>
                                        </div>
                                        <div class="china-form">
                                            <label for="exampleInputPassword1">Key Pix</label>
                                            <input type="text" class="china-form" value="<?= $data['pix']; ?>">
                                        </div>
                                    </div>
                            ...
                            <div class="box box-primary">
                                <div class="box-body">
                                    ...
                                    <div class="china-form">
                                        ...
                                        <input type="text" class="china-form" id="nomeUser" value="<?= $data_return['nome']; ?>" readonly>
                                    </div>
                                    <div class="china-form">
                                        <label for="tipoPix">Tipo Pix</label>
                                        <input type="text" class="china-form" id="tipoPix" value="<?= $data['tipo']; ?>" readonly>
                                    </div>
                                    <div class="china-form">
                                        <label for="keyPix">Key Pix</label>
                                        <input type="text" class="china-form" id="keyPix" value="<?= $data['pix']; ?>">
                                    </div>
