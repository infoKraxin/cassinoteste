...
<div class="topbar d-print-none">
    ...
    <h6 class="mb-0 fw-normal text-muted text-truncate fs-14" style="margin-top: 2px;">
        Integrado/Criado por 
        <a href="https://t.me/beltraxx" target="_blank" style="text-decoration: none; color: inherit;">
            Beltraxx
        </a)
    </h6>
</li>
